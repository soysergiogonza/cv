...
export function Profile({ profile, currentProfile, currentProfileIndex, totalProfiles, setCurrentProfileIndex, t }: any) {
  if (!currentProfile || totalProfiles === 0) {
    return (
      <section className="space-y-4 group">
        <h2 className="text-2xl font-semibold tracking-tight">{profile('sectionTitle')}</h2>
